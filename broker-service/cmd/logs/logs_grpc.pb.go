...
type LogServiceClient interface {
	WriteLog(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogReponse, error)
}
...
func (c *logServiceClient) WriteLog(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogReponse, error) {
	out := new(LogReponse)
...
type LogServiceServer interface {
	WriteLog(context.Context, *LogRequest) (*LogReponse, error)
...
func (UnimplementedLogServiceServer) WriteLog(context.Context, *LogRequest) (*LogReponse, error) {
